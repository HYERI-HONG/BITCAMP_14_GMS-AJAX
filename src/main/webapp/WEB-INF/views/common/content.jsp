				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
						<div class="col-lg-6 col-md-6 home-about-left">
							<img class="img-fluid" src="${context}/resources/img/about-img.png" alt="">
						</div>
                        ...
                        <div class="row grid">
                            	...
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${context}/resources/img/p1.jpg" alt="">
	                            	</div>
									<a href="${context}/resources/img/p1.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${context}/resources/img/preview.png" alt=""></div>
									  </div>
								</a>                              		
                            	</div>
								<div class="p-inner">
                            ...
                            <div class="single-portfolio col-sm-4 all raster">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${context}/resources/img/p2.jpg" alt="">
	                            	</div>
									<a href="${context}/resources/img/p2.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${context}/resources/img/preview.png" alt=""></div>
									  </div>
								</a>                              		
                            ...
                            <div class="single-portfolio col-sm-4 all ui">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${context}/resources/img/p3.jpg" alt="">
	                            	</div>
									<a href="${context}/resources/img/p3.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${context}/resources/img/preview.png" alt=""></div>
									  </div>
									</a> 
                            ...
                            <div class="single-portfolio col-sm-4 all printing">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${context}/resources/img/p4.jpg" alt="">
	                            	</div>
									<a href="${context}/resources/img/p4.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${context}/resources/img/preview.png" alt=""></div>
									  </div>
									</a>                            		
                            ...
                            <div class="single-portfolio col-sm-4 all vector">
                            	...
                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${context}/resources/img/p5.jpg" alt="">
	                            	</div>
									<a href="${context}/resources/img/p5.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${context}/resources/img/preview.png" alt=""></div>
									  </div>
									</a>                             		
                            ...
                            <div class="single-portfolio col-sm-4 all raster">
                            	<div class="relative">
	                            	<div class="thumb">
	                            		<div class="overlay overlay-bg"></div>
	                            		 <img class="image img-fluid" src="${context}/resources/img/p6.jpg" alt="">
	                            	</div>
									<a href="${context}/resources/img/p6.jpg" class="${context}/resources/img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${context}/resources/img/preview.png" alt=""></div>
									  </div>
									</a>                             		
		            ...
		            <div class="row">
		                <div class="active-testimonial">
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="img-fluid" src="${context}/resources/img/elements/user1.png" alt="">
		                        </div>
		                        <div class="desc">
		                            <p>
		                    ...
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="img-fluid" src="${context}/resources/img/elements/user2.png" alt="">
		                        </div>
		                        <div class="desc">
		                            <p>
				...
				<div class="container">
					...
					<div class="row">	
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="${context}/resources/img/b1.jpg" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="${context}/resources/img/user.png" alt="">
						...
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="${context}/resources/img/b2.jpg" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="${context}/resources/img/user.png" alt="">
						...
						<div class="single-recent-blog col-lg-4 col-md-4">
							<div class="thumb">
								<img class="f-img img-fluid mx-auto" src="${context}/resources/img/b3.jpg" alt="">	
							</div>
							<div class="bottom d-flex justify-content-between align-items-center flex-wrap">
								<div>
									<img class="img-fluid" src="${context}/resources/img/user.png" alt="">
		            ...
		            <div class="brand-wrap">
		                <div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${context}/resources/img/l1.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${context}/resources/img/l2.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${context}/resources/img/l3.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${context}/resources/img/l4.png" alt=""></a>
		                    </div>
		                    <div class="col single-brand">
		                        <a href="#"><img class="mx-auto" src="${context}/resources/img/l5.png" alt=""></a>
		                    </div>
		                </div>
		            </div>
		        </div>
